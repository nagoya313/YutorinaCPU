...
`define BusSlaveIndexLocale 29:27
`define BUS_SLABE_0         0
`define BUS_SLABE_1         1
`define BUS_SLABE_2         2
`define BUS_SLABE_3         3
`define BUS_SLABE_4         4
`define BUS_SLABE_5         5
`define BUS_SLABE_6         6
`define BUS_SLABE_7         7
